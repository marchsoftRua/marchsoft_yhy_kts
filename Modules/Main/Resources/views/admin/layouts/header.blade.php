		...
		<div class="layui-main mag0">
		    ...
		    <ul class="layui-nav top_menu">
				...
				<li class="layui-nav-item" id="userInfo">
					<a href="javascript:;">
						<img src="{{asset($user->head_url)}}" class="layui-nav-img userAvatar" width="35" height="35">
					...
					<dl class="layui-nav-child">
						...
						<dd><a href="/lauout" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
					</dl>
				</li>
			</ul>
		</div>
