layui.config({
    ...
    // $.get("Main/admin/json/newsList.json",
    // 	function(data){
    // 		var waitNews = [];
    ...
    //图片总数
    // $.get("Main/admin/json/images.json",
    // 	function(data){
    ...
    // //用户数
    // $.get("Main/admin/json/usersList.json",
    // 	function(data){
    ...
    // //新消息
    // $.get("Main/admin/json/message.json",
    // 	function(data){
    ...
    // }else{
    // 	$.ajax({
    // 		url : "Main/admin/json/systemParameter.json",
    // 		type : "get",
    // 		dataType : "json",
